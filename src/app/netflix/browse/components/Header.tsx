        ...
        <header className={styles.header}>
            <div className={styles.header__inner}>
                <div className={styles.header__wrap}>
                    ...
                    <nav>
                        ...
                        <ul className={styles.gnb}>
                            ...
                            <li>
                                <a href="/netflix/browse">NEW! 요즘 대세 콘텐츠</a>
                            </li>
                            <li>
                ...
                <div className={styles.util}>
                    <div className={styles.search}>
                        {isSearch ? (
                            <form
                                id="search-form"
                                action=""
                                className={`${styles.search__form} ${isSearch ? styles.search__on : ''}`}
                            ...
                            <button type="button" onClick={handleSearch} aria-label="검색창 열기">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                    ...
                    {isLogin ? (
                        <>
                            <button type="button" className={styles.profile} aria-label="계성&설정">
